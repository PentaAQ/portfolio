...
export const Header = () => {
  return (
    <header className="w-full fixed backdrop-blur-xl shadow-sm py-3 text-white bg-transparent animate-header z-10">
      <div className="w-full max-w-7xl mx-auto flex justify-between items-center px-2">
        ...
        <nav
          className="md:flex flex-col md:flex-row 
                ...
                peer-checked:max-md:h-44 transition-all duration-700 ease-in-out max-md:border-b max-md:border-b-gray-500 bg-neutral-900"
        >
          <ul className="capitalize flex md:gap-6 text-lg font-medium max-md:flex-col ">
            ...
            <li className="bg-transparent backdrop-blur-xl">
